    ...
    public function check_password_notice() {
        ...
        if ( $flagged ) {
            $warning = sprintf(
                ...
                __( 'WARNING', 'tms-theme-muumib2b' ),
                __( 'Your password has been compromised.', 'tms-theme-muumib2b' ),
                __( 'Please change your password <strong>as soon as possible</strong>.', 'tms-theme-muumib2b' )
            );
