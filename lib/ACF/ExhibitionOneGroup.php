...
class ExhibitionOneGroup {
     ...
     * Filled in the construct, overridable with 'tms/acf/exhibition_one_layouts' filter.
     *
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->components = \apply_filters(
            'tms/acf/exhibition_one_layouts',
            [
                'hero_and_image_carousel'        => Layouts\HeroAndImageCarouselLayout::class,
                ...
                'content_columns_exhibition_one' => Layouts\ContentColumnsExhibitionOne::class,
