...
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\ArchiveSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\HeaderSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\Error404SettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\ExceptionNoticeSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\FooterSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\MapSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\PageSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\SocialMediaSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\SitemapSettingsTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\ChatTab;
use TMS\Theme\MuumiB2B\ACF\Fields\Settings\PasswordPageSettingsTab;
...
class SettingsGroup {
    ...
    protected function register_fields() : void {
        try {
            $group_title = _x( 'Site settings', 'theme ACF', 'tms-theme-muumib2b' );
            ...
            $field_group->add_fields(
                apply_filters(
                    ...
                    [
                        ...
                        new PasswordPageSettingsTab( '', $field_group->get_key() ),
                    ],
                    $field_group->get_key()
                )
            );
