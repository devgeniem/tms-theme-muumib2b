...
class FooterSettingsTab extends Tab {
    ...
    public function sub_fields( $key ) {
        ...
        try {
            ...
            $phone_title_field = ( new Field\Text( $strings['phone_title']['title'] ) )
                ->set_key( "{$key}_phone_title" )
                ->set_name( 'phone_title' )
                ->set_wrapper_width( 50 )
                ->set_instructions( $strings['phone_title']['instructions'] );
            ...
            $bottom_logo_field = ( new Field\Image( $strings['bottom_logo']['title'] ) )
                ->set_key( "{$key}_bottom_logo" )
                ->set_name( 'bottom_logo' )
                ->set_return_format( 'id' )
                ->set_wrapper_width( 50 )
                ->set_instructions( $strings['bottom_logo']['instructions'] );

            $bottom_second_logo_field = ( new Field\Image( $strings['bottom_second_logo']['title'] ) )
                ->set_key( "{$key}_bottom_second_logo" )
                ->set_name( 'bottom_second_logo' )
                ->set_return_format( 'id' )
                ->set_wrapper_width( 50 )
                ->set_instructions( $strings['bottom_second_logo']['instructions'] );
