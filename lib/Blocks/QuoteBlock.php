...
namespace TMS\Theme\MuumiB2B\Blocks;

use Geniem\ACF\Block;
use TMS\Theme\MuumiB2B\ACF\Fields\QuoteFields;
 ...
 * Class QuoteBlock
 *
 * @package TMS\Theme\MuumiB2B\Blocks
 */
    ...
    public function filter_data( $data, $instance, $block, $content, $is_preview, $post_id ) : array {
        $classes = [
            ...
            'quote'     => [
                ...
                'is-size-5',
                \is_singular( [ Page::SLUG, Post::SLUG ] ) ? 'is-size-1' : 'is-size-5',
            ],
            'author'    => [
                'has-text-weight-medium',
                'is-family-secondary ',
