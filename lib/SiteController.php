    ...
    protected function init_page_for_posts() : void {
        try {
            $page_id = wp_insert_post( [
                ...
                'post_title'  => __( 'News', 'tms-theme-muumib2b' ),
                'post_status' => 'publish',
            ], true );
    ...
    protected function init_main_menu() : void {
        try {
            $menu_id = wp_create_nav_menu(
                __( 'Main menu', 'tms-theme-muumib2b' )
            );
    ...
    protected function init_site_settings() : void {
        try {
            $settings_id = wp_insert_post( [
                ...
                'post_title'  => __( 'Site settings', 'tms-theme-muumib2b' ),
                'post_status' => 'publish',
            ], true );
            ...
            $description = sprintf(
                ...
                _x( 'Sorry, the page you requested was not found. Please check that you spelled the address correctly. Or did you follow a link?', 'theme-frontend', 'tms-theme-muumib2b' ),
                _x( 'The page might not exist anymore or its name has changed. You might want to try to find the page you were looking for by', 'theme-frontend', 'tms-theme-muumib2b' ),
                _x( '– returning to the front page of the site', 'theme-frontend', 'tms-theme-muumib2b' ),
                _x( '– removing all characters after the last slash (/) in the address and try the shorter version of the address.', 'theme-frontend', 'tms-theme-muumib2b' )
