...
class Roles implements Controller {
    ...
    private function modify_superadmin_caps() : void {
        ...
        $role = \Geniem\Roles::create(
            'super_administrator',
            _x( 'Super Administrator', 'wp-geniem-roles', 'tms-theme-muumib2b' ),
            $admin->capabilities ?? []
        );
    ...
    private function modify_admin_caps() : void {
        ...
        $role->rename( _x( 'Moikka', 'wp-geniem-roles', 'tms-theme-muumib2b' ) );
    }
    ...
    private function modify_editor_caps() : void {
        ...
        $role->rename( _x( 'Site Manager', 'wp-geniem-roles', 'tms-theme-muumib2b' ) );
    }
    ...
    private function modify_author_caps() : void {
        ...
        $role->rename( _x( 'Author', 'wp-geniem-roles', 'tms-theme-muumib2b' ) );
    }
    ...
    private function modify_contributor_caps() : void {
        ...
        $role->rename( _x( 'Contributor', 'wp-geniem-roles', 'tms-theme-muumib2b' ) );
    }
    ...
    private function modify_subscriber_caps() : void {
        ...
        $role->rename( _x( 'Subscriber', 'wp-geniem-roles', 'tms-theme-muumib2b' ) );
    }
