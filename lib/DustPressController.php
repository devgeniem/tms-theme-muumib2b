...
use TMS\Theme\MuumiB2B\Helpers\ImageAdvanced;
...
class DustPressController implements Interfaces\Controller {
    ...
    protected function alter_pagination_data( $data ) : object {
        ...
        $data->S->next            = _x( 'Next', 'pagination', 'tms-theme-muumib2b' ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase
        $data->S->prev            = _x( 'Previous', 'pagination', 'tms-theme-muumib2b' ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase
