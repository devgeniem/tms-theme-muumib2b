 ...
 */
class GridFormatter implements \TMS\Theme\MuumiB2B\Interfaces\Formatter {
    ...
    public static function format_type_relationship( $data = [] ) {
        ...
        $link_title   = empty( $link_title ) ? __( 'Read more', 'tms-theme-muumib2b' ) : $link_title;
