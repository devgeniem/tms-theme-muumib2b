...
use DateTime;
use DateTimeZone;
use TMS\Theme\MuumiB2B\Interfaces\Formatter;
...
class CountdownFormatter implements Formatter {
    ...
    public static function format( array $data ) : array {
        ...
        $data['strings']['days']    = _x( 'Days', 'theme-frontend', 'tms-theme-muumib2b' );
        $data['strings']['hours']   = _x( 'Hours', 'theme-frontend', 'tms-theme-muumib2b' );
        $data['strings']['minutes'] = _x( 'Minutes', 'theme-frontend', 'tms-theme-muumib2b' );
        $data['strings']['seconds'] = _x( 'Seconds', 'theme-frontend', 'tms-theme-muumib2b' );
