...
use TMS\Theme\MuumiB2B\PostType\Page;
use TMS\Theme\MuumiB2B\PostType\Post;
use TMS\Theme\MuumiB2B\Settings;
use TMS\Theme\MuumiB2B\Traits\Breadcrumbs;
use TMS\Theme\MuumiB2B\Traits\Links;
...
class Search extends BaseModel {
    ...
    public function page_title() : string {
        return \__( 'Search results', 'tms-theme-muumib2b' );
    }
    ...
    public function form() {
        ...
        array_unshift(
            ...
            [
                'slug'       => 'all',
                'name'       => __( 'All', 'tms-theme-muumib2b' ),
        ...
        return [
            ...
            'filter_by_post_type' => __( 'Filter by post type', 'tms-theme-muumib2b' ),
            'filter_by_date'      => __( 'Filter by date', 'tms-theme-muumib2b' ),
            'filter_start_date'   => __( 'Start date', 'tms-theme-muumib2b' ),
            'filter_end_date'     => __( 'End date', 'tms-theme-muumib2b' ),
            'filter_results'      => __( 'Filter results', 'tms-theme-muumib2b' ),
        ];
    }
    ...
    public function results() {
        ...
        if ( $wp_query->have_posts() ) {
            ...
            $results_text = __( 'No search results', 'tms-theme-muumib2b' );
        }
