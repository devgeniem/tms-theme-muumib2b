...
class Footer extends Model {
     ...
     * @return mixed
     */
    public function bottom_logo() {
        return Settings::get_setting( 'bottom_logo' );
    }
     ...
     * @return mixed
     */
    public function bottom_second_logo() {
        return Settings::get_setting( 'bottom_second_logo' );
    }
    ...
    public function contact_info() {
        $info = [
            ...
            'phone_title' => Settings::get_setting( 'phone_title' ),
